...
int process_reads(
    std::istream& hin, 
    std::ostream& hout, 
    const std::vector<Biomics::SequenceMatcher<rwwb::sequtils::base_t> >& adapters, 
    const std::vector<std::string>& adapterlabel,
    ...
    std::vector<std::string> labels = std::vector<std::string>(buffersize, "NA") ;
    ...
    while(true) {
        ...
        // reset the labels
        labels = std::vector<std::string>(buffersize, "NA") ;
...
//
void adapter_helper(std::vector< std::vector<rwwb::sequtils::base_t> >& sequences, std::vector<std::string>& labels, std::string file_adapters ) {
    std::string label ;
...
int main(int argc, char** argv) {
    ...
    return_code = process_reads(hin, hout, adapters, adapterlabels, buffer_size) ;
