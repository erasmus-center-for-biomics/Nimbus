...
int main(int argc, char** argv) {
    ...
    desc.add_options()
        ...
        ("adapter,a", boost::program_options::value< std::vector<std::string> >(&adapter_sequences), "The sequence to trim")
        ("adapter-file,f", boost::program_options::value<std::string>(&file_adapters), "A fasta file with sequences to trim")
